...
public interface ScriptMethods {
     ...
     *
     * @param host    a DNS host name, or IP address. If a host name is passed,
     ...
     * @param ipPrefix  A string containing colon delimited IP prefix with top n
     *                  bits specified in the bit field (i.e. 3ffe:8311:ffff::/48
     *                  or 123.112.0.0/16).
     *
     ...
     */
    boolean timeRange(Object hour1,
                      Object min1,
                      Object sec1,
                      Object hour2,
                      Object min2,
